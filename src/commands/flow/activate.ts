...
import SFPLogger, { LoggerLevel, Logger, COLOR_KEY_MESSAGE, COLOR_HEADER, COLOR_ERROR } from '@n8codes/sfp-logger';
...
const messages = Messages.loadMessages('@n8codes/sfp', 'flow');
