...
import SFPLogger, { LoggerLevel, COLOR_KEY_MESSAGE } from '@n8codes/sfp-logger';
...
const messages = Messages.loadMessages('@n8codes/sfp', 'scratchorg_pool_metrics_publish');
