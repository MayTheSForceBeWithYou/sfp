...
import SFPLogger, { COLOR_KEY_MESSAGE, COLOR_WARNING, ConsoleLogger, Logger, LoggerLevel } from '@n8codes/sfp-logger';
...
import { COLOR_KEY_VALUE } from '@n8codes/sfp-logger';
